...
| `ExtensionManagerErrorHandling` (trait) + `DependencyBundle` | extension-load error handling + trait-bundle encapsulation | `Modules/Core/Shared/` |
...
| `ConfigLoader` + `TopologyParser` | YAML/PHP config inheritance + topology dependency resolution (circular-dep detection, strict throw) | `Modules/Core/Utils/` |
